...
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Imx2aXBzcXN3b3l0dXR1bGlia2x3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODA2MjI4NzQsImV4cCI6MjA5NjE5ODg3NH0.zRzoMoRT-RqEBoh7zymGNSdCgRTPpDXwUv52gK7QZYQ'; // supabase Anon Key 
const supabase = createClient(supabaseUrl, supabaseAnonKey);

export default function CreateUserPage() {
  // 1. State Form Input (Ditambahkan password & confirmPassword)
  ...
  // ==========================================
  // [EFEK & LOGIKA VALIDASI]
  // ==========================================

  // Ambil data Jenis Pekerjaan dari Supabase
  useEffect(() => {
  async function fetchJobs() {
    ...
    if (error) {
      console.error("Gagal mengambil data job_type:", error.message);
    } else if (data) {
      console.log("Data job_type berhasil didapat:", data);
      setJobs(data);
    }
  }
  fetchJobs();
  ...
  // Efek Validasi Password (Real-time check saat diketik)
  useEffect(() => {
  ...
  // ==========================================
  // [PROSES SUBMIT KE SUPABASE]
  // ==========================================
  const handleSubmit = async (e) => {
    e.preventDefault();

    // Validasi Akhir sebelum data dikirim
    ...
    try {
      // NOTE: Demi keamanan terbaik, daftarkan user melalui Supabase Auth!
      // Namun jika skema tabel kamu adalah menyimpan string password langsung (untuk diproses hash via Edge Function/API):
      const { error } = await supabase.from('user').insert([
        {
          ...
          foto_ktp: photoKtp,
          foto_selfie: photoSelfie,
          // Jangan lupa pastikan nama kolom di table user supabase kamu sudah ada, misal 'password'
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-6">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              {/* Indikator Checklist Kriteria Password Keamanan */}
